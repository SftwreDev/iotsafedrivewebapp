...
<template>
    <div class="min-h-full">
                    ...
                    >
                        ...
                        >
                                        ...
                                        >
                                            <span class="flex w-full items-center justify-between">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <span
                                                            class="inline-block h-16 w-16 overflow-hidden rounded-full bg-gray-100"
                                                        >
                                                            <img
                                                                alt=""
                            ...
                            <div class="mt-5 h-0 flex-1 overflow-y-auto">
                                ...
                                <nav
                                    v-if="role === 'super_admin' || role === 'rescuer'"
                                    class="mt-10 px-3"
                                >
                                    <div class="space-y-1">
                                        <a
        ...
        >
            <div class="flex flex-shrink-0 items-center px-6"></div>
...
const navigation = [
    { name: 'Profile', href: '/', icon: HomeIcon, current: lastSegmentPath === 'localhost:5173' },
    {
        ...
        href: '/settings',
        icon: Cog6ToothIcon,
        current: lastSegmentPath === 'settings'
    }
]
