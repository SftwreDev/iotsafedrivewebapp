                            ...
                            <form @submit.prevent="saveBtn">
                                <div class="sm:flex sm:items-start">
                                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                        ...
                                        <div v-for="(field, idx) in formFields" :key='idx'
                                             class="mt-5  border-t border-gray-200">
                                            <div class="mt-5">
                                                <label :for="field.name"
                                                       class="block text-sm font-medium leading-6 text-gray-900">{{ field.label
                                                    }}</label>
                                                <div class="mt-2">
                                        ...
                                        <div class="mt-5  border-t border-gray-200">
                                            <label class="block text-sm font-medium leading-6 text-gray-900 mt-5"
                                                   for="role">Role</label>
                                            <select
                                                id="role"
                                                v-model="role"
                                                ...
                                                required
                                            >
                                                <option v-for="(role, idx) in roleField"
                                                        :key="idx" :value="role.value">{{ role.label }}
                                                </option>
                                            </select>
                                        </div>
                    ...
                    <TransitionChild as="template" enter="ease-out duration-300"
                        ...
                        <DialogPanel
                            ...
                            <form>
                                    ...
                                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                        <DialogTitle as="h3" class="text-base font-semibold leading-6 text-gray-900">
                                            ...
                                            <p class="mt-2 text-sm text-gray-600">
                                                Please copy the email and password and send it to the user.
                                                <br>
                                                <span class="font-bold text-red-500">Note: </span>This information
                                ...
                                <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse border-t border-gray-200">
                                    <button
